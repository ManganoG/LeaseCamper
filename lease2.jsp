    ...
    <h1 style="color: white;">Ciao: questo &egrave un easter egg</h1>
        ...
        <%
            ...
            <%
                    ...
                    if(rs.next()){
                        out.println("<h1 style='color:red;'><b> Errore : questo camper &egrave gi&agrave stato noleggiato </b></h1>");
                    }else{
                        query1 = "INSERT INTO Noleggi (Targa,Proprietario,Affittuario,DataInizio,DataFine) values ('"+t+"', '"+p+"','"+nome+"' ,#"+DtIn+"#, #"+DtFn+"#);";
                        st.executeUpdate(query1);
                        out.println("<h1 style='color:red;'><b>Prenotazione eseguita correttamente</b></h1>");
